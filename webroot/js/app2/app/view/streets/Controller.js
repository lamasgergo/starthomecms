Ext.define('Tscrm.view.streets.Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.streetsController', 
/*
...
*/
    reloadGrid:function(){
        ...
        this.getViewModel().getStore('streetsList').load({
            scope: this,
...
*/      
    onRowDblClick: function (grid, record, index, eOpts) {
        win = new Tscrm.view.streets.View();
        win.setTitle(record.data.id);
...
*/
    loadViewData: function(controller,id,win){
        ...
        if(id!='')
        {
            ...
            var data = Ext.data.StoreManager.lookup('StreetsView').load({
                params:{
                    'id': id
                },
                callback: function(records, operation, success) {
...
*/       
    onEdit: function(view, rowIdx, colIdx, item, e, record, row){
        ...
        var formPanel = win.lookupReference('streetsForm');
        formPanel.mask("Adatok betöltése..."); 
        var form = formPanel.getForm(); 
               
        form.url='/admin/streets/edit.json';
        var data = Ext.data.StoreManager.lookup('StreetsView').load({
            params:{
                'id': record.data.id
            },
...
*/        
    onFormCancel: function() {
        this.lookupReference('streetsForm').getForm().reset();
        this.getView().close();
    },
/*
    Form save function
*/      
    onFormSave: function() {
        ...
        var vcontroller = this;
        var formPanel = this.lookupReference('streetsForm');
...
*/    
    ...
    onChangeCity: function(){
        ...
        streetField = vcontroller.lookupReference('street');
        
        streetField.setValue();
        districtField.setValue(false)
        
        districtField.getStore().getProxy().setExtraParam('city_id',cityField.getValue());
        districtField.getStore().load(); 
