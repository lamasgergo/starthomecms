Ext.define('Tscrm.view.showed_properties_contacts.Form', {
    extend: 'Ext.window.Window',
    alias: 'widget.showedPropertiesContactsForm',
    reference: 'showedPropertiesContactsFormWindow',
    requires : [
        'Tscrm.view.showed_properties_contacts.Controller',
        'Tscrm.view.showed_properties_contacts.Model'
    ],  
    viewModel: {
        type: 'showedPropertiesContactsModel'
    },          
    controller: 'showedPropertiesContactsController' ,    
    title: 'Megtekintés rögzítése',
    width: 1000,
    height: 600,
    closable: true,
    closeAction: 'destroy',
    ...
    items:[ 
        {
            ...
            reference: 'showedPropertiesContactsForm',
            border: false,  
            layout: {
                type: 'hbox',
                align: 'stretch'
                    ...
                    items:[
                    {
                            ...
                            items:[                    
                                {      
                                    ...
                                    valueField: 'id',
                                    tpl:'<tpl for="."><div class="x-boundlist-item x-combo-list-item fast-search-property" ><tpl if="mainimage !=\'\'"><img src="{mainimage}"></tpl><b>{address}</b><br>{fullname} ({phone1})<div class="clearfix"></div></div></tpl>' 
                                }  
                          ] 
                    },{
                        xtype: 'panel',
