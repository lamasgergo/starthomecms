...
%>
    ...
    public function edit($id = null)
    {
        ...
        {    
            $ret=$this->_saveData($id,__('<%= $currentModelName %> módosítása sikeres volt!'),__('<%= $currentModelName %> módosítás!'),['action' => 'index'],false,[<%= $this->Bake->stringifyList($belongsToMany, ['indent' => false]) %>]);
