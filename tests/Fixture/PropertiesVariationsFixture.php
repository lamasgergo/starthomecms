...
/**
 * PropertiesVariationsFixture
 *
 */
class PropertiesVariationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'common_cost' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            'fk_properties_variations_properties1_idx' => ['type' => 'index', 'columns' => ['property_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'property_id'], 'length' => []],
            'fk_properties_variations_properties1' => ['type' => 'foreign', 'columns' => ['property_id'], 'references' => ['properties', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'gdn' => 1,
            'active' => 1,
            'deleted' => '2015-06-18 15:01:10',
            'created' => '2015-06-18 15:01:10',
            'modified' => '2015-06-18 15:01:10'
        ],
    ];
}
