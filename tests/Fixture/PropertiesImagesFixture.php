...
class PropertiesImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ordered' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_properties_images_properties1_idx' => ['type' => 'index', 'columns' => ['property_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'property_id'], 'length' => []],
            'fk_properties_images_properties1' => ['type' => 'foreign', 'columns' => ['property_id'], 'references' => ['properties', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'size' => 1,
            'active' => 1,
            'deleted' => '2015-06-19 08:35:28',
            'created' => '2015-06-19 08:35:28',
            'modified' => '2015-06-19 08:35:28'
        ],
    ];
}
