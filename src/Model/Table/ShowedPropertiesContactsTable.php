...
use App\Model\Entity\ShowedPropertiesContact;
use Cake\ORM\Query;
 ...
 */
class ShowedPropertiesContactsTable extends Table
{
    ...
    {
        $this->table('showed_properties_contacts');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->add('properties_variation_id', 'valid', ['rule' => 'numeric'])
            ->requirePresence('properties_variation_id')
            ->notEmpty('properties_variation_id',__('A mezõ nem lehet üres!'))
